...
const Innovatum = () => {
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }} className="w-full">
            <h3 className="flex gap-1 font-medium text-xl font-titleFont" >Frontend Developer Intern<a className='text-textLight hover:text-textGreen duration-300' href="https://innovatumsciencepark.se/" target='_blank'><span className="text-textGreen tracking-wide" >@Innovatum</span></a> </h3>
