        ...
        <section id='project' className='max-w-container mx-auto lgl:px-20 py-24'>
            ...
            <div className="w-full flex flex-col items-center justify-between gap-28 mt-10">
                ...
                <ProjectCard image={adminDashboad2} projectName={"ERP Solution for a K-12 Institution"} skills={[
                    ...
                    { id: 4, skill: "Tailwind CSS" },
                    { id: 5, skill: "Redux" },
                ]} content={'The ERP solution I developed for K-12 institutions is a comprehensive software platform designed to streamline administrative processes and improve efficiency. It integrates student management, academics, finance, HR, and communication functionalities into a unified system. With intuitive interfaces and customizable features, it facilitates easy access to essential data and enables seamless coordination between departments. By automating routine tasks, providing real-time insights, and fostering better communication, my ERP solution empowers K-12 institutions to enhance productivity, transparency, and ultimately, the quality of education they deliver.'} githubHref='' figmaHref='' webHref='https://portal.dayspringacademy.co/' />
